  ...
  return <>
    <section className="cms-product-images-manager" aria-labelledby="cms-product-images-title">
      ...
      {selectedImages.length > 0 && (
        <div data-cms-selected-photo-actions style={{position:"sticky",top:76,zIndex:60,display:"flex",gap:10,flexWrap:"wrap",alignItems:"center",padding:"12px 14px",marginTop:14,border:"1px solid #cbdbe4",borderRadius:10,background:"#f8fbfd",boxShadow:"0 6px 16px rgba(15,54,80,.12)"}}>
