...
export default function StorefrontShopSections({ market, say, mode = "all" }: Props) {
  ...
  const ageGroups = [
    ...
    { fr: "3–5 ans", en: "3–5 years", image: "/hero-client/01-costume.webp", age: "3-5-ans", tone: "yellow" },
    { fr: "6–8 ans", en: "6–8 years", image: "/hero-client/02-jouets.webp", age: "6-8-ans", tone: "blue" },
    { fr: "9–12 ans", en: "9–12 years", image: "/hero-client/03-complicite.webp", age: "9-12-ans", tone: "green" },
    { fr: "12 ans et +", en: "12 years +", image: "/hero-client/04-sourires.webp", age: "12-plus", tone: "rose" },
  ];
