...
export default function StorefrontNavigation({ market, whatsappUrl, say }: Props) {
  ...
  return <div className="ref-header">
    <div className="ref-top wrap"><span>🇨🇦 {say("Entreprise canadienne","Canadian business")}</span><b>{say("Des enfants heureux aujourd’hui, un meilleur demain !","Happy children today, a better tomorrow!")}</b>
