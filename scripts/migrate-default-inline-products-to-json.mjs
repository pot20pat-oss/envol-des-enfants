...
if (source[arrayStart] !== "[") throw new Error("defaultProducts does not start with an array literal");
...
if (!Array.isArray(products) || products.length === 0) throw new Error("No inline default products extracted");

fs.mkdirSync(path.join(root, "data"), { recursive: true });
fs.writeFileSync(path.join(root, "data", "default-products.json"), `${JSON.stringify(products, null, 2)}\n`);
